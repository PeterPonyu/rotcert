% ==========================================================================
% rotcert manuscript (2026-07-11). Journal-agnostic article class; IEEEtran
% port is a submission-time packaging step (target venue IEEE TGRS -- see
% VENUE-FIT-MEMO.md).
%
% NUMBERS DISCIPLINE: every quantitative result carries a "% source:" comment
% pointing at the frozen result JSON. G1 coverage is reported OUT-OF-SAMPLE
% (R=20 scene-split); the in-sample audit is kept only as a labelled diagnostic
% (see the in-sample->out-of-sample correction in Methods/Threats). Sources:
% pilot_oos_2026-07-11/ (DOTA) and dior_cert_results_2026-07-11/ (DIOR-R).
% Holm-8 RUN 2026-07-12 under the signed freeze (GWD smaller 8/8 at nominal alpha; DEMOTED to descriptive --
% single-split degenerate at 1/2001 floor; holm8_2026-07-12/). PRIMARY efficiency support is the post-hoc
% coverage-matched ablation (coverage_matched_2026-07-13/): size gap mostly baseline over-coverage, survives
% only vs like-for-like naive baseline on DIOR-R (~0.8x). R=20 across-split = split-sensitivity, NO p-value.
% AOPG repro executed 2026-07-13 (aopg_repro_2026-07-13/; FAIL vs +-0.5 cross-method; same-method anchor 64.30 [ding2026], disclosed).
% ==========================================================================
...
\newcommand{\todo}[1]{\textcolor{red}{[\textbf{GATED}: #1]}}

\setlength{\parskip}{0.4em}

\title{\textbf{Angle-aware conformal certification for oriented object detection:\\
out-of-sample localization coverage and certified recall on DOTA and DIOR-R}}
\author{Zeyu Fu\thanks{Correspondence: \href{mailto:fuzeyu99@126.com}{fuzeyu99@126.com}.
ORCID 0009-0001-8329-0108. TODO-USER: affiliation block for submission.}}
\date{\today}
...
\begin{abstract}
% Abstract ~235 words after the 2026-07-14 Config-A extension note (was ~190); the full degeneracy
% mechanics, the regime-conditional naive-CP audit, and per-cell CIs live in the body.
\noindent Oriented (rotated) object detectors ship without a distribution-free reliability guarantee. Porting
